...
class Profile(models.Model):
    ...
    profile_picture = models.ImageField(upload_to='profile_pics/',default='https://www.shutterstock.com/shutterstock/photos/738763984/display_1500/stock-vector-default-unisex-profile-icon-framed-flat-vector-graphic-on-isolated-background-738763984.jpg')    
